        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-20">
            <div className="bg-white px-5 py-10 rounded-3xl border-2 border-gray-100 transform scale-10">
                ...
                <div className="mt-6 flex flex-col gap-y-4">
                    <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-cyan-600 text-white text-sm font-bold">
                        Iniciar sesión
                    </button>
